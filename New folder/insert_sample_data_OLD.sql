...
INSERT INTO course VALUES (1, 'basic dirt skill', 'beginner dirt class', '2023-01-31', 100, 'dirt'),(2, 'advance street skill', 'advance street class with great instructors', '2023-01-30', 120.00 , 'street'),(3, 'basic street skill', 'beginner street class, very easy', '2023-01-30', 100, 'street');
...
INSERT INTO enrolled_in VALUES (2,1,true,70,80,90,100,20,70),(1,2,true,70,80,90,70,40,70),(1,3,true,56,86,99,99,70,40),(3,4,true,20,20,10,90,20,50),(3,5,false,60,60,60,50,90,70),(1,6,true,80,100,99,100,100,89),(1,7,false,70,80,90,100,20,70);

INSERT INTO uses VALUES (1,1,'BOTH'),(2,2,'AM'),(3,3,'PM');

INSERT INTO taught_in VALUES (2,'A','PM'),(3,'A','AM');

INSERT INTO instructs VALUES(6,3),(1,3),(2,3),(3,3),(4,2),(1,2),(2,2),(3,2),(4,1),(5,1),(6,1);
